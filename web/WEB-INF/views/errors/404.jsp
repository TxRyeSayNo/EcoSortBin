...
<head>
    ...
    <title>Không tìm thấy trang - EcoSortBin</title>
...
<body style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background-color: var(--background);">
    <div class="empty-state" style="background: white; border-radius: var(--radius-lg); box-shadow: var(--shadow-md); padding: 60px; max-width: 500px; text-align: center;">
        <div class="empty-icon" style="color: var(--primary); font-size: 64px; margin-bottom: 24px;">
            <i class="fa-solid fa-map-location-dot"></i>
        </div>
        <h1 style="font-size: 24px; color: var(--text-primary); margin-bottom: 16px;">404 - Không tìm thấy trang</h1>
        <p style="margin-bottom: 32px; color: var(--text-secondary);">Trang bạn đang tìm kiếm không tồn tại hoặc đã bị di chuyển.</p>
